...
export default function FormApoderado() {
  ...
  useEffect(() => {
    const getApoderado = (apoderadoId) => {
      colegioApi
    ...
    if (id !== undefined) getApoderado(id);
  }, [id, setFormState]);
  ...
  const actualizarApoderado = (apoderadoId) => {
    colegioApi
      .put(`/apoderado/${apoderadoId}`, {
        nombres,
        apellidoPaterno,
        apellidoMaterno,
        email,
    ...
    <div className="m-auto my-8 flex w-fit flex-col items-center gap-10 border-t border-gray-100 p-10 shadow-xl">
      <div className="flex flex-col">
        ...
        <span className="text-lg font-medium">
          {id === undefined ? 'Registro del Apoderado' : 'Editar Apoderado'}
        </span>
      </div>
      <div>
      ...
      <div className="flex gap-10">
        <button
          ...
          onClick={() => {
            if (id === undefined) agregarApoderado();
            else actualizarApoderado(id);
          }}
        >
          Guardar
        </button>
